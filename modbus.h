...
#define StartTimer2 TCNT2=dTCNT2; TCCR2=0x05; //(128 prescaler)
#define InitTimer2 TIFR&=0x7F;TIMSK|=(1<<TOIE2);
...
extern BYTE DOC_registers[]; // 1-9999, Discrete Output Coils (Read-Write)
extern BYTE DIC_registers[]; // 10001-19999, Discrete Input Contacts (Read-Only)
extern BYTE AIR_registers[]; // 30001-39999, Analog Input Registers (Read-Only)
extern BYTE AOHR_registers[]; // 40001-49999, Analog Output Holding Registers (Read-Write)
